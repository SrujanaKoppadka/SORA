...
const allMenuItems = [
  ...
  { category: 'starters', name: "Wok Fried Edamame", price: "₹290", tag: "", image: imgWokFriedEdamame, desc: "Steamed edamame stir-fried in a delightful garlic and oyster sauce glaze", isVeg: true },
  { category: 'rice_bowls', name: "Chahan", price: "₹350", tag: "", image: imgChahan, desc: "Japanese fried rice dish prepared with rice as a primary ingredient and many optional additional ingredients and seasonings.", isVeg: false },
  { category: 'rice_bowls', name: "Yakimeshi", price: "₹350", tag: "", image: imgYakimeshi, desc: "Delicious Japanese-style fried rice is stir-fried vegetables and flavored with miso paste, giving it a deep umami flavor", isVeg: true },
  { category: 'rice_bowls', name: "Veg Katsu Curry Don", price: "₹360", tag: "", image: imgVegKatsuCurryDon, desc: "Crispy breaded vegetable cutlet served over a bowl of steamed sticky rice, served with Japanese curry sauce.", isVeg: true },
  { category: 'rice_bowls', name: "Oyakodon", price: "₹390", tag: "", image: imgOyakodon, desc: "Bowl of white rice that is topped with chicken, eggs, and chopped scallions.", isVeg: false },
  { category: 'rice_bowls', name: "Salmon Maze Gohan", price: "₹390", tag: "", image: imgSalmonMazeGohan, desc: "Salmon flakes, and umami-packed vegetables flavored with soy sauce and butter.", isVeg: false },
  { category: 'rice_bowls', name: "Chicken Katsu Curry Don", price: "₹390", tag: "", image: imgChickenKatsuCurryDon, desc: "Food featuring a crispy, panko-breaded chicken cutlet (katsu) served over steamed short-grain rice", isVeg: false },
  { category: 'ramen', name: "Miso Ramen", price: "₹360 - 410", tag: "", image: imgMisoRamen, desc: "A rich, savory broth flavored with fermented soybean paste", isVeg: false },
  { category: 'ramen', name: "Curry Ramen", price: "₹360 - 410", tag: "", image: imgRamenPlaceholder, desc: "Fusion dish combining traditional Japanese ramen noodles with rich, aromatic curry flavors", isVeg: false },
  { category: 'ramen', name: "Korean Ramen", price: "₹360 - 410", tag: "", image: imgKoreanRamen, desc: "Spicy and comforting ramen featuring a fiery broth, chewy noodles, and traditional Korean seasonings.", isVeg: false },
  { category: 'ramen', name: "Tonkotsu Ramen", price: "₹360 - 410", tag: "", image: imgTonkotsuRamen, desc: "A rich and creamy pork-bone broth simmered for hours, served with tender chashu pork and fresh noodles.", isVeg: false },
  { category: 'ramen', name: "Shoyu Ramen", price: "₹360 - 410", tag: "", image: imgShoyuRamen, desc: "Classic Tokyo-style ramen featuring a clear, soy sauce-based broth with a deep, savory umami flavor.", isVeg: false },
  { category: 'sushi', name: "Salmon Avocado", price: "₹310", tag: "", image: imgSalmonAvocado, desc: "Fresh, buttery salmon and creamy avocado rolled perfectly in seasoned sushi rice and seaweed.", isVeg: false },
  { category: 'sushi', name: "Asparagus Tempura", price: "₹280", tag: "", image: imgAsparagusTempura, desc: "Crispy battered asparagus spears rolled in sushi rice, offering a delightful crunch in every bite.", isVeg: true },
  { category: 'sushi', name: "Crispy Chicken", price: "₹290", tag: "", image: imgCrispyChicken, desc: "Tender fried chicken rolled with fresh vegetables and drizzled with a savory Japanese sauce.", isVeg: false },
  { category: 'sushi', name: "Ebi Tempura", price: "₹290", tag: "", image: imgEbiTempura, desc: "Golden, crispy tempura shrimp rolled with cucumber and avocado, topped with a sweet eel sauce.", isVeg: false },
  { category: 'sushi', name: "Veg California", price: "₹270", tag: "", image: imgVegCalifornia, desc: "A refreshing vegetarian take on the classic roll, filled with crisp cucumber, avocado, and carrots.", isVeg: true },
  { category: 'sushi', name: "Kimchi Futomaki", price: "₹290", tag: "", image: imgKimchiFutomaki, desc: "A thick sushi roll packed with spicy, tangy fermented kimchi and fresh vegetables.", isVeg: true },
  { category: 'sushi', name: "Kani Kuri", price: "₹290", tag: "", image: imgKaniKuri, desc: "Delicate crab stick meat paired with creamy avocado and cucumber in a traditional sushi roll.", isVeg: false },
  { category: 'beverages', name: "Coke", price: "MRP", tag: "", image: imgCoke, desc: "Classic, refreshing Coca-Cola served chilled over ice.", isVeg: true },
  { category: 'beverages', name: "Coke Zero", price: "MRP", tag: "", image: imgCokeZero, desc: "The great taste of Coca-Cola with zero sugar and zero calories.", isVeg: true },
  { category: 'beverages', name: "Diet Coke", price: "MRP", tag: "", image: imgDietCoke, desc: "Crisp and refreshing Diet Coke with a light, sparkling finish.", isVeg: true }
];
